...
OutputDir={#OUTPUTDIR}\windows
OutputBaseFilename=teo-{#TEOVERSION}-setup
Compression=lzma
InternalCompressLevel=ultra
WizardImageFile={#OUTPUTDIR}\windows\inno\teo-big-img.bmp
WizardSmallImageFile={#OUTPUTDIR}\windows\inno\teo-small-img.bmp
...
[Files]
; ------------------------- Executables -------------------------------
Flags: ignoreversion; Languages: en; DestDir: "{app}\bin"; Source: "{#OUTPUTDIR}\windows\en\cc90hfe-com.exe"; DestName: "cc90hfe.exe"
Flags: ignoreversion; Languages: fr; DestDir: "{app}\bin"; Source: "{#OUTPUTDIR}\windows\fr\cc90hfe-com.exe"; DestName: "cc90hfe.exe"
Flags: ignoreversion; Languages: en; DestDir: "{app}"; Source: "{#OUTPUTDIR}\windows\en\teow.exe"
Flags: ignoreversion; Languages: fr; DestDir: "{app}"; Source: "{#OUTPUTDIR}\windows\fr\teow.exe"
Flags: ignoreversion; Languages: en; DestDir: "{app}"; Source: "{#OUTPUTDIR}\windows\en\cc90hfe.exe"
Flags: ignoreversion; Languages: fr; DestDir: "{app}"; Source: "{#OUTPUTDIR}\windows\fr\cc90hfe.exe"
...
; ------------------------- Root files -------------------------------
Flags: ignoreversion; DestDir: "{app}"; Source: "README.txt"; DestName: "README.TXT"; Languages: en
Flags: ignoreversion; DestDir: "{app}"; Source: "LISEZMOI.txt"; DestName: "LISEZMOI.TXT"; Languages: fr
