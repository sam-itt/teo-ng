...
'mgwmake.bat' compile the executables in the folders 'misc/pack/windows/en'
and 'misc/pack/windows/fr'  (the folders are created if they don't exist).
...
All the packages are then in the folders :
    - misc/pack/windows/
    - misc/pack/msdos/
    - misc/pack/linux/
