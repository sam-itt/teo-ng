 ...
 * comment: <code> <code+shift> <code+altgr> */
#define TEO_KEY_A           1     /*  q Q    */
#define TEO_KEY_B           2     /*  b B    */
#define TEO_KEY_C           3     /*  c C    */
#define TEO_KEY_D           4     /*  d D    */
#define TEO_KEY_E           5     /*  e E    */
#define TEO_KEY_F           6     /*  f F    */
#define TEO_KEY_G           7     /*  g G    */
#define TEO_KEY_H           8     /*  h H    */
#define TEO_KEY_I           9     /*  i I    */
#define TEO_KEY_J           10    /*  j J    */
#define TEO_KEY_K           11    /*  k K    */
#define TEO_KEY_L           12    /*  l L    */
#define TEO_KEY_M           13    /*  , ?    */
#define TEO_KEY_N           14    /*  n N    */
#define TEO_KEY_O           15    /*  o O    */
#define TEO_KEY_P           16    /*  p P    */
#define TEO_KEY_Q           17    /*  a A    */
#define TEO_KEY_R           18    /*  r R    */
#define TEO_KEY_S           19    /*  s S    */
#define TEO_KEY_T           20    /*  t T    */
#define TEO_KEY_U           21    /*  u U    */
#define TEO_KEY_V           22    /*  v V    */
#define TEO_KEY_W           23    /*  z Z    */
#define TEO_KEY_X           24    /*  x X    */
#define TEO_KEY_Y           25    /*  y Y    */
#define TEO_KEY_Z           26    /*  w W    */
#define TEO_KEY_0           27    /*  à 0 @  */
#define TEO_KEY_1           28    /*  & 1    */
#define TEO_KEY_2           29    /*  é 2    */
#define TEO_KEY_3           30    /*  " 3 #  */
#define TEO_KEY_4           31    /*  ' 4 {  */
#define TEO_KEY_5           32    /*  ( 5 [  */
#define TEO_KEY_6           33    /*  - 6    */
#define TEO_KEY_7           34    /*  è 7    */
#define TEO_KEY_8           35    /*  _ 8 \  */
#define TEO_KEY_9           36    /*  ç 9 ^  */
#define TEO_KEY_0_PAD       37    /*  0 0 0  */
#define TEO_KEY_1_PAD       38    /*  1 1 1  */
#define TEO_KEY_2_PAD       39    /*  2 2 2  */
#define TEO_KEY_3_PAD       40    /*  3 3 3  */
#define TEO_KEY_4_PAD       41    /*  4 4 4  */
#define TEO_KEY_5_PAD       42    /*  5 5 5  */
#define TEO_KEY_6_PAD       43    /*  6 6 6  */
#define TEO_KEY_7_PAD       44    /*  7 7 7  */
#define TEO_KEY_8_PAD       45    /*  8 8 8  */
#define TEO_KEY_9_PAD       46    /*  9 9 9  */
...
#define TEO_KEY_COLON       68    /*  m M    */
#define TEO_KEY_QUOTE       69    /*  ù %    */
