 ...
 *  Modifié par:
 *
 *  Gestion des disquettes SAP.
 */


#ifndef MEDIA_DISK_SAP_H
#define MEDIA_DISK_SAP_H

extern int sap_IsSap (const char filename[]);
extern int sap_LoadDisk (int drive, const char filename[]);
