 ...
 */
static int dfloppy_ReadSector(int drive, int track, int sector, int nsects, unsigned char data[])
{
 ...
 */
static int dfloppy_WriteSector(int drive, int track, int sector, int nsects, const unsigned char data[])
{
    struct floppy_cmd fd_cmd;
 ...
 */
static int dfloppy_FormatTrack(int drive, int track, const unsigned char header_table[])
{
    struct floppy_cmd fd_cmd;
    int format_type = 0;
 ...
 */
int dfloppy_Init(int to_drive_type[4], int enable_write)
{
    __dpmi_regs r;
    int i, num_drives = 0;
