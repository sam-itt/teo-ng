...
void init_printer_notebook_frame (GtkWidget *notebook)
{
    ...
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(widget), teo.lprt.dip);
    g_signal_connect(G_OBJECT(widget), "toggled", G_CALLBACK(check_button_toggled), (gpointer) &teo.lprt.dip);
    ...
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(widget), teo.lprt.nlq);
    g_signal_connect(G_OBJECT(widget), "toggled", G_CALLBACK(check_button_toggled), (gpointer) &teo.lprt.nlq);
